...
def reauthenticate_user(client_id):
    ...
    print("Reauthenticating user...", flush=False)
...
def setup_cognito(agent_name: str):# -> dict[str, Any] | dict[str, Any] | None:
    try:
...
def get_cognito_config(agent_name: str):
    ...
    try:
        ...
        existing_credentials: dict[str, Any] = json.loads(
            existing_credentials_response["SecretString"]
        )
